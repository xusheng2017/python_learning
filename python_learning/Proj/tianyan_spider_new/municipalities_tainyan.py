...
# 用户名,密码(vip)
# 帐号列表
account_number = [{'user_name': '18112128953', 'pass_word': '1qaz2wsx'},
                  {'user_name': '17551027266', 'pass_word': '1qaz2wsx'},
                  {'user_name': '17714196157', 'pass_word': '1qaz2wsx'},
                  {'user_name': '13865009316', 'pass_word': '1qaz2wsx'},
                  ]
# 存储有效帐号
user_name = account_number[1]['user_name']
pass_word = '1qaz2wsx'
# user_name = '17551027266'
# pass_word = '1qaz2wsx'
# user_name = '18112128953'
# pass_word = '1qaz2wsx'
# -----------------------------------------------------------
# user_name = '18457199821'
# pass_word = '1qaz2wsx'
# user_name = '18894583667'
# pass_word = '1qaz2wsx'
# user_name = '18751875534'
# pass_word = '1qaz2wsx'
# user_name = '15251883798'
# pass_word = '1qaz2wsx'
# -----------------------------------------------------------
# user_name = '18014491226'
# pass_word = '1qaz2wsx'
# user_name = '18551822797'
# pass_word = '1qaz2wsx'
# user_name = '15605151075'
# pass_word = '1qaz2wsx'
# user_name = '13584051676'
# pass_word = '1qaz2wsx'
# -----------------------------------------------------------
# user_name = '13654429729'
# pass_word = '1qaz2wsx'
# user_name = '15902013101'
# pass_word = '1qaz2wsx'
...
class TianYan(object):
    ...
    def get_response(self):
        ...
        city_page_list = []
        for i in range(1, 2):
            city_page_list.append("https://bj.tianyancha.com/search/p{}".format(str(i)))
        # 公司url列表
        company_url_list = []
        for url in city_page_list:
            ...
            try:
                ...
                try:
                    ...
                    self.parse_page_response(html_response, company_url_list, city_name)
            # 如果第一次请求获取响应
            else:
                # 判断是否有验证码
                if re.match(r'https://antirobot\.tianyancha\.com/captcha/verify', response.url):
                ...
                # 解析每一页的响应内容
                self.parse_page_response(html_response, company_url_list, city_name)
                logging.info("------------解析当前页数据成功-----------")

    # 解析每一页的响应内容
    def parse_page_response(self, html_response, company_url_list, city, province="municipalities"):
        global user_name
        global pass_word
            ...
            try:
                ...
                try:
                    ...
                    # 判断是否封号
                        ...
                        html_response = response.content.decode()
                    self.parse_company_response(html_response, province, city, company_url, add_register_capital, add_register_time)
            # 如果第一次请求获取响应
            else:
                # 判断是否有验证码
                if re.match(r'https://antirobot\.tianyancha\.com/captcha/verify', response.url):
    ...
    # 解析每一家公司的详情页内容
    def parse_company_response(self, html_response, province, city, company_url, add_register_capital, add_register_time):
        el = etree.HTML(html_response)
        company_web_top = dict()
        try:
            # 获取基础信息
            company_web_top['company_name'] = el.xpath('//*[@id="company_web_top"]/div[2]/div[2]/div[1]/span/text()')[0]
        except:
        ...
        tianyan_logger.info('获取公司基础信息:{}'.format(pprint.pformat(company_web_top)))
        ...
        tianyan_logger.info('获取企业基本信息：{}'.format(pprint.pformat(basic_info)))
        ...
        tianyan_logger.info('获取公司成员及职位：{}'.format(str(member_list)))
        ...
        tianyan_logger.info('获取公司股东信息：{}'.format(str(shareholder_list)))
        ...
        tianyan_logger.info('获取公司融资历史：{}'.format(str(finance_history_list)))
        ...
        tianyan_logger.info('获取企业变更记录：{}'.format(str(change_log_list)))
        ...
        tianyan_logger.info('获取公司法律诉讼记录：{}'.format(str(legal_proceeding_list)))
        ...
        tianyan_logger.info('获取公司法院公告：{}'.format(str(court_notice_list)))
        ...
        tianyan_logger.info('获取公司行政处罚：{}'.format(str(announce_list)))
        ...
        tianyan_logger.info('获取公司详细信息：{}'.format(pprint.pformat(company)))
